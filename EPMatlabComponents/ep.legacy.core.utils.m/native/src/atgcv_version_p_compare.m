function [nComp, bTrailEqual] = atgcv_version_p_compare(varargin)
% Compare current Matlab/TargetLink version (including p-Postfix for patches) to reference version. 
%
% function [nComp, bTrailEqual] = atgcv_version_p_compare(sRefVersion)
%
%   INPUT                   DESCRIPTION
%
...
%                                  tool is not installed
%
%                                  Note: "p%d" is _not_ interpreted as trailer
%                                  but as "micro"-number: TL3.0.1p1 is
