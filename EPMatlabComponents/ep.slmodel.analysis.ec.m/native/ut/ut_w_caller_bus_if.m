function ut_w_caller_bus_if
% Check wrapper creation for callers with buses in the interface
%
...
sAtsName = 'ar_wrapper_caller_bus_if';

sPwd = pwd;
sTestRoot = fullfile(sPwd, ['tmp_', mfilename()]);
[xOnCleanupDoCleanupEnv, xEnv, sResultDir, stTestData] = sltu_prepare_ats_env(sAtsName, 'UT_EC', sTestRoot);
