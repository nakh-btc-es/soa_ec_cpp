function ut_export_function_matchGraphItf
% Test to cover the "Allow arguments - Match graphical interface" feature in conjunction with an export function model
...
sModel = 'export_function_matchGraphItf'; 
