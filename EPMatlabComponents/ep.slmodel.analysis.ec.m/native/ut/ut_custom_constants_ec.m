function ut_custom_constants_ec
...
[xOnCleanupDoCleanupEnv, xEnv, sResultDir, stTestData] = sltu_prepare_ats_env('CustomConstants', 'EC', sTestRoot);
...
%% assert
sTestDataDir = fullfile(ut_get_testdata_dir(), 'CustomConstants');
...
%%change config
copyfile(fullfile(sTestDataDir, 'ecacfg_analysis.m'), fileparts(sResultDir));
