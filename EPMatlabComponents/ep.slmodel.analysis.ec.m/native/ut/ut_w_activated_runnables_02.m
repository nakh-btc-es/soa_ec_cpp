function ut_w_activated_runnables_02
% Generic check for EC including the creation of a wrapper for the AUTOSAR model.
%

%%
if verLessThan('matlab', '9.10')
    MU_MESSAGE('TEST SKIPPED: Currently not possible to create a valid Wrapper for ML versions lower ML2021a.');
    return;
end
...
%% arrange and act
sSuiteName = 'UT_EC';
sModelName = 'ar_activated_runnables_02';
