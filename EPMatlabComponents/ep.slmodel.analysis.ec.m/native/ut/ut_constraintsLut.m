...
sPwd = pwd;
sTestDataDir = fullfile(ut_get_testdata_dir(), 'ConstraintsLUT');

sTestRoot = fullfile(sPwd, ['tmp_', mfilename()]);
[xOnCleanupDoCleanupEnv, xEnv, sResultDir, stTestData] = sltu_prepare_ats_env('ConstraintsLUT', 'EC', sTestRoot);
