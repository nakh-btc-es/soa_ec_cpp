function ut_ep_1806
% Checking fix for EP-1806: ExportFunction model is not handled as expected with the export function being
% mapped to the corresponding triggered subsystems.
...
[xOnCleanupDoCleanupEnv, xEnv, sResultDir, stTestData] = ...
    sltu_prepare_ats_env('ExportFunctionModel', 'EC', sTestRoot);
...
%% assert
sTestDataDir = fullfile(ut_get_testdata_dir(), 'ExportFunctionModel');
