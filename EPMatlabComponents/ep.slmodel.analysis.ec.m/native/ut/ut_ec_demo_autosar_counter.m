function ut_ec_demo_autosar_counter
...
[xOnCleanupDoCleanupEnv, xEnv, sResultDir, stTestData] = ...
    sltu_prepare_ats_env('EC_demo_autosar_counter', 'EC', sTestRoot);
...
%% assert
sTestDataDir = fullfile(ut_get_testdata_dir(), 'EC_demo_autosar_counter');
...
ut_ec_assert_valid_message_file(stResult.sMessages, {'EP:SLC:INFO'});
end
