function ut_sl_sil_analysis_06
...
[xOnCleanupDoCleanupEnv, xEnv, sResultDir, stTestData] = sltu_prepare_ats_env('model_ws_params_sl_sil', 'UT_EC', sTestRoot);
...
%% assert
sTestDataDir = fullfile(ut_get_testdata_dir(), 'model_ws_params_sl_sil');
