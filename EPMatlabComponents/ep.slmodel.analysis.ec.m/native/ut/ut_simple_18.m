...
[xOnCleanupDoCleanupEnv, xEnv, sResultDir, stTestData] = sltu_prepare_ats_env('BusPort_EC', 'EC', sTestRoot);
...
%% assert
sTestDataDir = fullfile(ut_get_testdata_dir(), 'simple_18');
