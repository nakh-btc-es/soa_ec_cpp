function ut_param_check_support_ar_21_11
% Handling of Simulink.LookupTable and Simulink.BreakPoint in AUTOSAR context.
%


if verLessThan('matlab', '9.14')
    MU_MESSAGE('Skipping the test, because this UT is only relevant for ML2023a and above!');
    return;
end
...
%% arrange and act
sModelUT = 'ar_param_01_supportR21-11';
