function ut_aa_methods_multi_args
...
%% arrange and act
sSuiteName = 'UT_EC';
sModelName = 'aa_methods_multi_args';
...
bCheckCompilable = false; % model uses unsupported features (arrays), no succesfull code compilation expected
