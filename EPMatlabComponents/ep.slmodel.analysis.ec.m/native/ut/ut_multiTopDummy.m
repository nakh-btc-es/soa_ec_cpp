...
sPwd = pwd;
sTestDataDir = fullfile(ut_get_testdata_dir(), 'multiTopDummy');

sTestRoot = fullfile(sPwd, ['tmp_', mfilename()]);
[xOnCleanupDoCleanupEnv, xEnv, sResultDir, stTestData] = sltu_prepare_ats_env('MultiTopDummy_EC', 'EC', sTestRoot);
