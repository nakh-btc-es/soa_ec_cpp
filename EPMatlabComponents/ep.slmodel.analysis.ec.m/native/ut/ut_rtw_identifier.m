function ut_rtw_identifier
% Handling of CoderInfo.identifer attributes for signals and parameters.
%

%% arrange and act
sModelUT = 'rtw_identifier';
...
SLTU_ASSERT_EQUAL_MESSAGES(sExpectedMessagesFile, stResult.sMessages, {'EP:SLC:INFO', 'EP:SLC:WARNING'});
end
