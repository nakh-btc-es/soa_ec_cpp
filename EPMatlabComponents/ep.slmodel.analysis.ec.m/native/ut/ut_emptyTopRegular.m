...
sPwd = pwd;
sTestDataDir = fullfile(ut_get_testdata_dir(), 'emptyTopRegular');

sTestRoot = fullfile(sPwd, ['tmp_', mfilename()]);
[xOnCleanupDoCleanupEnv, xEnv, sResultDir, stTestData] = sltu_prepare_ats_env('EmptyTopRegular_EC', 'EC', sTestRoot);
