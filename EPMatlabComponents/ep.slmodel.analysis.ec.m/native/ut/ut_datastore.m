...
%% assert
sTestDataDir = fullfile(ut_get_testdata_dir(), 'datastore');
...
ut_ec_assert_valid_message_file(stResult.sMessages, {'EP:SLC:INFO', 'EP:SLC:WARNING', 'ATGCV:MOD_ANA:DS_USAGE_READWRITE'});
end
