function ut_ep_1988
% Checking handling of Limitation EP-1988: Triggered/enabled subsystems are not supported
...
[xOnCleanupDoCleanupEnv, xEnv, sResultDir, stTestData] = sltu_prepare_ats_env('TriggeredEnabledSubs', 'EC', sTestRoot);
...
%% assert
sTestDataDir = fullfile(ut_get_testdata_dir(), 'TriggeredEnabledSubs');
