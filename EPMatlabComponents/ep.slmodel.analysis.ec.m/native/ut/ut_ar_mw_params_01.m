function ut_ar_mw_params_01
% Handling of Simulink.Parameter objects that are located inside the model workspace.
%
...
sTestDataDir = fullfile(ut_get_testdata_dir(), ['UT_EC_', sModelUT], sVersionDir);
