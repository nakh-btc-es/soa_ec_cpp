function ut_many_stubs_single
% UT for creating the required ccode-stubs with custom settings in a single stub file
...
sCodeModelPath = fullfile(sTestDataDir, 'single');
