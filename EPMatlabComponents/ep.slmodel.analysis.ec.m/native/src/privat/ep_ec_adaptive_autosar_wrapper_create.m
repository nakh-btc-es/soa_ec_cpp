function stResult = ep_ec_adaptive_autosar_wrapper_create(stArgs)
% Creates a wrapper model for adaptive AUTOSAR models that can be used as a testing framework.
%
% function stResult = ep_ec_adaptive_autosar_wrapper_create(stArgs)
%
%  INPUT              DESCRIPTION
...
sImplFuncName = 'ep_ec_aa_wrapper_create_impl';
