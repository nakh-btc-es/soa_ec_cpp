function aoItfs = getCalibrationParameters(oEca, oScope)
% Finds among the already modelwise analyzed parameters the ones used in this scope (subsystem).

abIsPartOfScope = i_isPartOfScope(oEca.aoModelWiseCalParams, oScope);
aoItfs = oEca.aoModelWiseCalParams(abIsPartOfScope);
