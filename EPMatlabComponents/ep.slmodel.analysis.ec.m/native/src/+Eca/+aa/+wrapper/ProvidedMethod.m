classdef ProvidedMethod
% A SL function block corresponding to a *provided* AA method.
    ...
    methods
        ...
        function sName = getCodeGlobalFunction(oObj)
            if isempty(oObj.sFieldAccessKind)
                sName = Eca.aa.CodeSymbols.getProvidedMethodFunc( ...
                    oObj.sArInterfaceName, oObj.sArPortName, oObj.sArMethodName);
            else
                switch oObj.sFieldAccessKind
                    case 'get'
                        sName = Eca.aa.CodeSymbols.getProvidedFieldGetterFunc( ...
                            oObj.sArInterfaceName, oObj.sArPortName, oObj.sArFieldName);
                    case 'set'
                        sName = Eca.aa.CodeSymbols.getProvidedFieldSetterFunc( ...
                            oObj.sArInterfaceName, oObj.sArPortName, oObj.sArFieldName);
                    otherwise
