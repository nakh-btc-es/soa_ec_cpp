...
stConfig.sCFile          = fullfile(sThisPath, 'ecp_stub_swc_scheduler.c');
stConfig.casIncludePaths = {sThisPath, 'A:\BcD', 'x:/yZ'};
stConfig.sStepFunName    = 'swc_wrapper_scheduler_step';
stConfig.sInitFunName    = 'swc_wrapper_scheduler_init';
end
