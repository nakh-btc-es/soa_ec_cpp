function ut_bug_16083
% UPDATED LEGACY UT
% Old name: ut_mt01_bug_16083
%   REMARK
%    * testing fix for signal back-propagation problem: loops in the model
%      can cause infinite recursion in atgcv_m01_signal_info_get()
