function ut_fuelsys_cal
% UPDATED LEGACY UT
% Old name: ut_simenv_ft01_ma_tl22_cal
%
% Legacy comment:
% Suite: ModelAna; Test: model analysis with TL 4.3 fuelsys model, SF chart with cal
% enabled
% SF in subsystem hierarchy

%% cleanup
sltu_cleanup();

%% arrange
sUTModel = 'fuelsys_cal';
sUTSuite = 'UT_TL';
