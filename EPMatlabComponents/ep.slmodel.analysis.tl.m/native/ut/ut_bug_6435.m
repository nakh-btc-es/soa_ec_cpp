function ut_bug_6435
% UPDATED LEGACY UT
% Old name: ut_modelana_mt01_b6435
%
%  BTS/6435
%  Problem exemplified on Variable 'V_Calvariable':
%     Calibration Variable "StateChart", which is part of subsystem
%     "AtomicSubsystem1" was wrongly declared to be also part of
%     subsystem "AtomicSubsystem".
%
%  Test: Check that "StateChart" is only associated with "AtomicSubsystem1"
%        and not "AtomicSubsystem".
