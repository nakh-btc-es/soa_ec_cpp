function ut_bug_15199
% UPDATED LEGACY UT
% Old name: ut_mt01_bug_15199
%   REMARK
%     Check fix for BTS/15199. Issue no errors for subsystems that do not
%     have Inputs/Outputs (IO via MemoryBlocks).
