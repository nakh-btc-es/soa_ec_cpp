function ut_fix_datatypes
% test to cover the removal of sfix/ufix datatypes from TL models when they are not even part of the interface

%% check ML version
if verLessThan('matlab', '9.7')
    MU_MESSAGE('TEST SKIPPED: This test is not suitable for ML versions less than ML2019b.');
    return;
end
