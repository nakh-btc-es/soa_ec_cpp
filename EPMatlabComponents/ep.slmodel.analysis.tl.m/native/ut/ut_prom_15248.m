function ut_prom_15248
% UPDATED LEGACY UT
% Old name: ut_mt01_prom_13496
% Check fix for PROM-15248
%
%     PROM-15248: Exception during analysing a test model using matrix signals.
%
...
%% act
% note: test model is using dependent inputs a lot; however, since we want to test the mappings anyway, we need to
%       accept it for testing
ep_ma_internal_property('set', 'accept_dependent_code_inputs', 'yes');
xOnCleanupRemoveInternalProp = onCleanup(@() clear('ep_ma_internal_property'));
