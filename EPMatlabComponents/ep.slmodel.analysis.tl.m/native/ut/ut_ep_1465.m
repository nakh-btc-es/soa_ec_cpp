function ut_ep_1465
% UPDATED LEGACY UT
% Old name: ut_mt01_ep_1465
%   REMARK
%    * testing fix for following problem:
%        - the DD is also including "invisible" SF-Objects like SF-Machines
%          inside their block tree. Asking objects of this block for their
%          model path via dsdd_get_block_path will yield a fake/invalid path.
%          Model analysis runs into errors because it does not take into
%          account such invalid model paths.
