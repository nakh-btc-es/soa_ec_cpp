function ut_bug_25848
% UPDATED LEGACY UT
% Old name: ut_mt01_bug_25848
% checking fix for limitation BTS/25848
%
%   REMARK
%    * BTS/25848 (taking care of limitation)
%      - Cal variables based on BlockSpecification area of Pool inside 
%        the DD shall be rejected as Explicit Parameter because they
%        cause problems during MIL Simulation (i.e. MIL model is not
%        synchronized with DD, so the values set by ET are not propagated
%        into the MIL model)
%
