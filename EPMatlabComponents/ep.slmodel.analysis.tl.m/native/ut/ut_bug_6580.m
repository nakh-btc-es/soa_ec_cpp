function ut_bug_6580
% UPDATED LEGACY UT
% Old name: ut_modelana_mt01_b6580
%
% Suite: testing fix for BTS/6580
% - bug is caused by multiple entries of the same interface variable
% - so check, that the same variables are not entered multiple times in the same
%   port for a test_model
