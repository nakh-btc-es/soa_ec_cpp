...
%% act
% note: fake SL data by simply re-using TL model data
[stResult, oEx] = ut_ep_model_check(xEnv, sModelFile, ...
    'TlInitScript', sInitScript, ...
...
casExpectedModules = {'model:lib_model', 'library:lib_a', 'library:lib_b'};
...
casFoundModules = arrayfun(@i_getModuleKey, stResult.astSlModules, 'uni', false); 
SLTU_ASSERT_STRINGSETS_EQUAL(casExpectedModules, casFoundModules);
end
