...
sPwd      = pwd();
sTestRoot = fullfile(sPwd, 'signals_05');
sDataDir  = fullfile(ut_local_testdata_dir_get(), 'virtual_bus_tl');

sTlModel      = 'virtual_bus_tl';
...
try 
    ...
    xExp('top_A|inport:In3') = struct('type', 'virtual', 'obj', '');
    
    xExp('top_A|outport:Out1') = struct('type', 'not_bus', 'obj', '');
    xExp('top_A|outport:Out2') = struct('type', 'not_bus', 'obj', '');
    
    xExp('sub_B1|inport:In1') = struct('type', 'virtual', 'obj', '');
    
    xExp('sub_B1|outport:Out1') = struct('type', 'not_bus', 'obj', '');
    xExp('sub_B1|outport:Out2') = struct('type', 'virtual', 'obj', '');
    
    xExp('sub_B2|inport:In1') = struct('type', 'virtual', 'obj', '');
    
    xExp('sub_B2|outport:Out1') = struct('type', 'not_bus', 'obj', '');
    xExp('sub_B2|outport:Out2') = struct('type', 'virtual', 'obj', '');
