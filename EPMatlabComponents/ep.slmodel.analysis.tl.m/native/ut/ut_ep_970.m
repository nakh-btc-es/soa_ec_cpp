function ut_ep_970
% UPDATED LEGACY UT
% Old name: ut_mt01_ep_970
% Check fix for EP-970
%
%     EP-970: CAL objects with the same DD identifier get all the same name, making the interface worse to read and
%             causing problems in later update scenarios.
%    
