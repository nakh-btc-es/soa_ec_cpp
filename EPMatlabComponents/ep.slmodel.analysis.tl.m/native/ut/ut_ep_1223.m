function ut_ep_1223
% UPDATED LEGACY UT
% Old name: ut_mt01_ep_1223
%
%   EP-1223: Issues with reading out block variables in context of merged subsystems.
%            The analysis of MIL-SIL relationships for this particular model is broken
%            for the ports of the may small action-subsystems.
%
%   Note: The current fix does not really solve the issue but circumvents it by avoiding 
