function ut_mux_busports
% UPDATED LEGACY UT
% Old name: ut_simenv_ft01_ma_tl22_mux
%
%  SC2401:simple_hiearchy -- ModelAnalysis shall not analyze subsystems 
%  with MUX or Busports input or output signals

%% cleanup
sltu_cleanup();

%% arrange
sUTModel = 'mux_busports';
sUTSuite = 'UT_TL';
