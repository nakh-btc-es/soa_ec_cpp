function ut_bug_22235
% UPDATED LEGACY UT
% Old name: ut_mt01_bug_22235
% checking fix for BTS/22235
%
%   REMARK
%    * part of problem in BTS/22235
%      - CAL/DISP variables are not correctly found if the model paths to the
%        subsystems contain special chars (intrepretable by RegExp)
%
