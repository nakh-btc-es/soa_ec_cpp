function ut_ep_legacy_converter_08
% Check Legacy converter functionality.
%
%  ut_ep_legacy_converter_08
%
...
sPwd      = pwd();
sTestRoot = fullfile(sPwd, 'legacy_conv_08');
sDataDir  = fullfile(ut_local_testdata_dir_get(), 'LegacyConverter', 'model4');
...
MU_ASSERT_EQUAL(mxx_xmltree('get_attribute', ahSubsystemNodes(1), 'name'), 'AtomicSubsystem', 'Unexpected subsystem name.');
MU_ASSERT_EQUAL(mxx_xmltree('get_attribute', ahSubsystemNodes(2), 'name'), 'Subsystem1', 'Unexpected subsystem name.');
