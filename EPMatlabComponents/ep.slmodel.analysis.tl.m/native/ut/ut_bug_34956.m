function ut_bug_34956
% UPDATED LEGACY UT
% Old name: ut_mt01_bug_34956
% checking fix for BTS/34956
%
%   BTS/34956: argument references to primitive Types are not replaced
%   properly (refrence to same Variable could be provided twice)
%
