function ut_modelana_mt01_slcheck3
...
%
%   $Revision: 195951 $ 
%   Last modified: $Date: 2015-03-19 14:39:33 +0100 (Do, 19 Mrz 2015) $ 
%   $Author: frederikb $


%% FIXED POINT DataType used
if ~license('test', 'fixed_point_toolbox') || (atgcv_version_compare('ML8.1') < 0 ...
        && ~license('test', 'fixed-point_blocks'))
...
sPwd               = pwd;
sRootDir           = fullfile(pwd, 'mt01_slcheck3');
sDataDir           = fullfile(ut_local_testdata_dir_get(), 'sl_tl_signal_types');
...
try
    ...
    astRes = mxx_xmltool(sMaFileNew, '//ma:Input/*//ma:ifName', ...
        'signalType', 'slSignalType');
    nExp = 10; %expecting 10 input signals
