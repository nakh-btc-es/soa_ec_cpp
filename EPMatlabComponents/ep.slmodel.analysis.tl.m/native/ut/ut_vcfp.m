function ut_vcfp
% UPDATED LEGACY UT
% Old name: ut_simenv_ft01_ma_b6397
%
% Suite: ModelAna; Test: TL_vcfp: Determine and call the generated

%% check TL version
if ~verLessThan('TL', '4.3')
    MU_MESSAGE('TEST SKIPPED. Testdata seems to destabilize Matlab (seen for ML2017b) when run with TL4.3 or higher.');
    return;
end
