function ut_bug_6410
% UPDATED LEGACY UT
% Old name: ut_modelana_mt01_b6410
%
% Suite: ModelAna; Test: BTS/6149 scenario simple_interface

%% check ML version
if (~verLessThan('matlab', '9.6') && verLessThan('matlab', '9.7'))
    MU_MESSAGE('TEST SKIPPED: Exactly the version ML2019a cannot cope with the negative start index for SF-Arrays.');
    return;
end
