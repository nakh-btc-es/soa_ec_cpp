function ut_simulink_numtype_no_fpb
% UPDATED LEGACY UT
% Old name: ut_mt01_sim_types_01
%
% Uses the model variant without fixed point blocks.
%
% Legacy comment:
%    * Fix is actually a support for the Simulink.NumericType

%% cleanup
sltu_cleanup();

%% arrange
sUTModel = 'simulink_numtype_no_fpb';
sUTSuite = 'UT_TL';
