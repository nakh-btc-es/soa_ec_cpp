function ut_bug_36728a
% UPDATED LEGACY UT
% Old name: ut_mt01_bug_36728a
% checking fix for BTS/36728a
%
%   BTS/36728: Multiple MERGEABLE_DISP shall be tolerated if found inside ports
%              that are just letting the DISP signal pass.
%
...
if ~verLessThan('tl', '5.2')
    MU_MESSAGE('TEST SKIPPED: Test model is using a TL-block that is not supported by TL5.2 anymore.');
    return;
end
