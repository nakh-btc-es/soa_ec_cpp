function ut_bug_7719
% UPDATED LEGACY UT
% Old name: ut_modelana_mt01_b7719
%
%   REMARK:
%        CAL-const block is falsely rejected as input because heuristic in
%        ModelAnalysis assumes multiple usages/references in Model.
%% cleanup
sltu_cleanup();
