function ut_bug_27973
% UPDATED LEGACY UT
% Replaces old ut ut_mt01_bug_27973  
%   REMARK
%    * BTS/27973
%      Ambiguous bus signal names are leading to an exception during signal
%      backpropagation.
...
%% check ML version, skip test for 2022b or higher
if (atgcv_version_p_compare('ML9.13') >= 0)
    MU_MESSAGE('TEST SKIPPED. Bus signals with the same name will cause an error since ML2022b.');
    return;
end
