function ut_variable_signal_width
% UPDATED LEGACY UT
% Old name: ut_simenv_ft01_ma_tl31_variable_width
%
% Suite: ModelAna; Test: model analysis with TL 3.1 feature: variable
% signal width
...
%% arrange
sUTModel = 'variable_signal_width';
sUTSuite = 'UT_TL';
