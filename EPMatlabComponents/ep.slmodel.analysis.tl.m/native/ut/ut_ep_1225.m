function ut_ep_1225
% UPDATED LEGACY UT
% Old name: ut_mt01_ep_1225
%
%   EP-1225: TL is introducing an additional variable reference for variables from the CustomBlock. If these
%            variables are CALs they are not accepted by EP because used in a read-only context. However,
%            from the analysis point of view these locations should be filtered out as "artificial locations".
%
%   Fix: Inputs/Outputs/States of CustomCode blocks are considered artificial locations for CAL variables and properly
%        filtered out.
%    
