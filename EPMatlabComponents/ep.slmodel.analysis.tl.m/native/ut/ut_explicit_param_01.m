function ut_explicit_param_01
% UPDATED LEGACY UT
% Old name: ut_mt01_explicit_param_01
%
% testing support of ExplicitParameter (workspace variables are structs)
%
%   supporting struct workspace variables for ExplicitParam (BTS/28152)
%  
