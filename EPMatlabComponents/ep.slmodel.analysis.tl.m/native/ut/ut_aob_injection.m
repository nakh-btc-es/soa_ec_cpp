function ut_aob_injection
% Checking filtering mechanism for DS injection based on AoB signals.
%

%%
if verLessThan('tl', '5.1')
    MU_MESSAGE('TEST SKIPPED: Testdata is using AoB injection signals supported by TL5.1 and higher.');
    return;
end
