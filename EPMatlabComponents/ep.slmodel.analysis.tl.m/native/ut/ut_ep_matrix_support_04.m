function ut_ep_matrix_support_04
% Test the matrix support feature
%
%  ut_ep_matrix_support_04
%
%  INPUT             DESCRIPTION
%
%  OUTPUT            DESCRIPTION
...
sPwd      = pwd();
sTestRoot = fullfile(sPwd, 'ut_ep_matrix_support_04');
sDataDir  = fullfile(ut_local_testdata_dir_get(), 'matrix_sig_models', 'matrix_sig4', 'tl40');
...
i_check_interface_object(hTlRoot, 'outport', 'Out2', [], 1, 3, 'double', 'fixedPoint', 1);
