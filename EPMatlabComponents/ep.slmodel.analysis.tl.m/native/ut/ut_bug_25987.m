function ut_bug_25987
% UPDATED LEGACY UT
% Old name: ut_mt01_bug_25987
%
%   REMARK
%    * BTS/25987
%      Error situation: Disp variable is not filtered out although the corresponding
%      signal is running into  a Merge block.
%      --> TechnicalReason: Signal is not running directly into Merge block, but is
%            transferred through a Mux block.
%      --> Fix: better filtering algo
%
% checking fix for BTS/25987
