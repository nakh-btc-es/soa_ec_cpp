function xOnCleanupCloseModels = ut_load_models(xEnv, varargin)
% Load model(s) via API for UnitTests. Note that _no_ explicit upgrade is done.
%
%  function xOnCleanupCloseModels = ut_load_model(xEnv, varargin)
% 
% Two operating modes using varargin:
%
%   1) Opening just one Model
%         xOnCleanupCloseModels = ut_load_model(xEnv, sModelFile, sInitFile, bIsTL)
%
%  
%   2) Opening multiple Models
%         xOnCleanupCloseModels = ut_load_model(xEnv, caxArgs1, caxArgs2, ...)
%
%
%
