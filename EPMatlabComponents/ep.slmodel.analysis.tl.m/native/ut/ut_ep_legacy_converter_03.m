function ut_ep_legacy_converter_03
% Check Legacy converter functionality.
%
%  ut_ep_legacy_converter_03
%
...
sPwd      = pwd();
sTestRoot = fullfile(sPwd, 'legacy_conv_03');
sDataDir  = fullfile(ut_local_testdata_dir_get(), 'LegacyConverter', 'prom9398');
...
ahLogicalTypeInfo = mxx_xmltree('get_nodes', hTlResultFile, ...
    '//calibration[@path="sim_TqDcd/Subsystem/sim_TqDcd/CalTqDcdboolEnQlyCheckDt4"]/miltype/boolean');
MU_ASSERT_EQUAL(1, length(ahLogicalTypeInfo), 'Wrong type information provided.');
end
