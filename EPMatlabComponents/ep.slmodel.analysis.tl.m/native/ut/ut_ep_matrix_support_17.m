function ut_ep_matrix_support_17
% Test the matrix support feature
%
%  ut_ep_matrix_support_17
%
%  INPUT             DESCRIPTION
%
%  OUTPUT            DESCRIPTION
...
sPwd      = pwd();
sTestRoot = fullfile(sPwd, 'ut_ep_matrix_support_17');
sDataDir  = fullfile(ut_local_testdata_dir_get(), 'matrix_sig_models', 'matrix_sig17', 'tl40');
...
i_check_interface_object(hTlRoot, 'inport', 'sub_B1/In1', [], 1, 6, 'double', 'fixedPoint');
i_check_interface_object(hTlRoot, 'outport', 'sub_B1/Out1', [], 1, 6, 'double', 'fixedPoint');
i_check_interface_object(hTlRoot, 'display', 'sub_B1/Gain', [], 1, 6, 'double', 'fixedPoint');

i_check_interface_object(hTlRoot, 'inport', 'sub_B2/In1', [], 1, 6, 'double', 'fixedPoint');
i_check_interface_object(hTlRoot, 'outport', 'sub_B2/Out1', [], 1, 6, 'double', 'fixedPoint');
i_check_interface_object(hTlRoot, 'display', 'sub_B2/Gain', [], 1, 6, 'double', 'fixedPoint');
...
i_check_interface_object(hTlRoot, 'inport', 'sub_B5/In1', [], 2, 3, 'double', 'fixedPoint');
i_check_interface_object(hTlRoot, 'outport', 'sub_B5/Out1', [], 2, 3, 'double', 'fixedPoint');
i_check_interface_object(hTlRoot, 'display', 'sub_B5/Gain', [], 2, 3, 'double', 'fixedPoint');
end
...
% test 'top_A/Subsystem/top_A/sub_B1/Gain(1)' on 
...
ahIoMapping = mxx_xmltree('get_nodes', hMapRoot, ...
    ...
    '/Path[@path="top_A/Subsystem/top_A/sub_B1/Gain(1)"]/..']);
...
for i = 1:length(ahIoMapping);
    ...
    MU_ASSERT_TRUE(~isempty(mxx_xmltree('get_nodes', hIoMappingIn1, ['./Path[@refId="id0" and', ...
        ' @path="top_A/Subsystem/top_A/sub_B1/Gain(1)"]'])));
    MU_ASSERT_TRUE(~isempty(mxx_xmltree('get_nodes', hIoMappingIn1, './Path[@refId="id1" and @path="Sa2_Gain"]')));
...
% test 'top_A/Subsystem/top_A/sub_B1/Gain(1)' on  'top_A/Subsystem/top_A/sub_B1'
ahIoMapping = mxx_xmltree('get_nodes', hMapRoot, ...
    ['//ScopeMapping/Path[@path="top_A/Subsystem/top_A/sub_B1"]/../InterfaceObjectMapping[@kind="Local"]', ...
    '/Path[@path="top_A/Subsystem/top_A/sub_B1/Gain(1)"]/..']);
MU_ASSERT_TRUE(length(ahIoMapping) == 6);
for i = 1:length(ahIoMapping);
    hIoMappingIn1 = ahIoMapping(i);
...
% test 'top_A/Subsystem/top_A/sub_B2/Gain(1)' on  'top_A/Subsystem/top_A'
ahIoMapping = mxx_xmltree('get_nodes', hMapRoot, ...
    ['//ScopeMapping/Path[@path="top_A/Subsystem/top_A"]/../InterfaceObjectMapping[@kind="Local"]', ...
    '/Path[@path="top_A/Subsystem/top_A/sub_B2/Gain(1)"]/..']);
MU_ASSERT_TRUE(length(ahIoMapping) == 6);
for i = 1:length(ahIoMapping);
    hIoMappingIn1 = ahIoMapping(i);
    [a,b] = ind2sub([1,6],i);
    MU_ASSERT_TRUE(~isempty(mxx_xmltree('get_nodes', hIoMappingIn1, ['./Path[@refId="id0" and', ...
        ' @path="top_A/Subsystem/top_A/sub_B2/Gain(1)"]'])));
    MU_ASSERT_TRUE(~isempty(mxx_xmltree('get_nodes', hIoMappingIn1, './Path[@refId="id1" and @path="Sa3_Gain"]')));
    hSignalMapping = mxx_xmltree('get_nodes', hIoMappingIn1, './SignalMapping');
    MU_ASSERT_TRUE(~isempty(mxx_xmltree('get_nodes', hSignalMapping, ...
        ['./Path[@refId="id0" and @path="(',num2str(a),')(',num2str(b),')"]'])));
    MU_ASSERT_TRUE(~isempty(mxx_xmltree('get_nodes', hSignalMapping, ...
...
% test 'top_A/Subsystem/top_A/sub_B2/Gain(1)' on  'top_A/Subsystem/top_A/sub_B2'
ahIoMapping = mxx_xmltree('get_nodes', hMapRoot, ...
    ['//ScopeMapping/Path[@path="top_A/Subsystem/top_A/sub_B2"]/../InterfaceObjectMapping[@kind="Local"]', ...
    '/Path[@path="top_A/Subsystem/top_A/sub_B2/Gain(1)"]/..']);
MU_ASSERT_TRUE(length(ahIoMapping) == 6);
for i = 1:length(ahIoMapping);
    hIoMappingIn1 = ahIoMapping(i);
...
% test 'top_A/Subsystem/top_A/sub_B3/Gain(1)' on  'top_A/Subsystem/top_A'
ahIoMapping = mxx_xmltree('get_nodes', hMapRoot, ...
    ['//ScopeMapping/Path[@path="top_A/Subsystem/top_A"]/../InterfaceObjectMapping[@kind="Local"]', ...
    '/Path[@path="top_A/Subsystem/top_A/sub_B3/Gain(1)"]/..']);
MU_ASSERT_TRUE(length(ahIoMapping) == 1);
MU_ASSERT_TRUE(~isempty(mxx_xmltree('get_nodes', ahIoMapping, ['./Path[@refId="id0" and ', ...
    ' @path="top_A/Subsystem/top_A/sub_B3/Gain(1)"]'])));
MU_ASSERT_TRUE(~isempty(mxx_xmltree('get_nodes', ahIoMapping, './Path[@refId="id1" and @path="Sa4_Gain"]')));
hSignalMapping = mxx_xmltree('get_nodes', ahIoMapping, './SignalMapping');
MU_ASSERT_TRUE(isempty(hSignalMapping));

% test 'top_A/Subsystem/top_A/sub_B3/Gain(1)' on  'top_A/Subsystem/top_A/sub_B3'
ahIoMapping = mxx_xmltree('get_nodes', hMapRoot, ...
    ['//ScopeMapping/Path[@path="top_A/Subsystem/top_A/sub_B3"]/../InterfaceObjectMapping[@kind="Local"]', ...
    '/Path[@path="top_A/Subsystem/top_A/sub_B3/Gain(1)"]/..']);
MU_ASSERT_TRUE(length(ahIoMapping) == 1);
MU_ASSERT_TRUE(~isempty(mxx_xmltree('get_nodes', ahIoMapping, ['./Path[@refId="id0" and',...
    ' @path="top_A/Subsystem/top_A/sub_B3/Gain(1)"]'])));
...
% test 'top_A/Subsystem/top_A/sub_B4/Gain(1)' on  'top_A/Subsystem/top_A'
ahIoMapping = mxx_xmltree('get_nodes', hMapRoot, ...
    ['//ScopeMapping/Path[@path="top_A/Subsystem/top_A"]/../InterfaceObjectMapping[@kind="Local"]', ...
    '/Path[@path="top_A/Subsystem/top_A/sub_B4/Gain(1)"]/..']);
MU_ASSERT_TRUE(length(ahIoMapping) == 1);
MU_ASSERT_TRUE(~isempty(mxx_xmltree('get_nodes', ahIoMapping, ['./Path[@refId="id0" and', ...
    ' @path="top_A/Subsystem/top_A/sub_B4/Gain(1)"]'])));
MU_ASSERT_TRUE(~isempty(mxx_xmltree('get_nodes', ahIoMapping, './Path[@refId="id1" and @path="Sa5_Gain"]')));
hSignalMapping = mxx_xmltree('get_nodes', ahIoMapping, './SignalMapping');
MU_ASSERT_TRUE(isempty(hSignalMapping));

% test 'top_A/Subsystem/top_A/sub_B4/Gain(1)' on  'top_A/Subsystem/top_A/sub_B4'
ahIoMapping = mxx_xmltree('get_nodes', hMapRoot, ...
    ['//ScopeMapping/Path[@path="top_A/Subsystem/top_A/sub_B4"]/../InterfaceObjectMapping[@kind="Local"]', ...
    '/Path[@path="top_A/Subsystem/top_A/sub_B4/Gain(1)"]/..']);
MU_ASSERT_TRUE(length(ahIoMapping) == 1);
MU_ASSERT_TRUE(~isempty(mxx_xmltree('get_nodes', ahIoMapping, ['./Path[@refId="id0" and', ...
    ' @path="top_A/Subsystem/top_A/sub_B4/Gain(1)"]'])));
...
% test 'top_A/Subsystem/top_A/sub_B5/Gain(1)' on  'top_A/Subsystem/top_A'
ahIoMapping = mxx_xmltree('get_nodes', hMapRoot, ...
    ['//ScopeMapping/Path[@path="top_A/Subsystem/top_A"]/../InterfaceObjectMapping[@kind="Local"]', ...
    '/Path[@path="top_A/Subsystem/top_A/sub_B5/Gain(1)"]/..']);
MU_ASSERT_TRUE(length(ahIoMapping) == 1);
MU_ASSERT_TRUE(~isempty(mxx_xmltree('get_nodes', ahIoMapping, ['./Path[@refId="id0" and ', ...
    ' @path="top_A/Subsystem/top_A/sub_B5/Gain(1)"]'])));
MU_ASSERT_TRUE(~isempty(mxx_xmltree('get_nodes', ahIoMapping, './Path[@refId="id1" and @path="Sa6_Gain"]')));
hSignalMapping = mxx_xmltree('get_nodes', ahIoMapping, './SignalMapping');
MU_ASSERT_TRUE(isempty(hSignalMapping));

% test 'top_A/Subsystem/top_A/sub_B5/Gain(1)' on  'top_A/Subsystem/top_A/sub_B5'
ahIoMapping = mxx_xmltree('get_nodes', hMapRoot, ...
    ['//ScopeMapping/Path[@path="top_A/Subsystem/top_A/sub_B5"]/../InterfaceObjectMapping[@kind="Local"]', ...
    '/Path[@path="top_A/Subsystem/top_A/sub_B5/Gain(1)"]/..']);
MU_ASSERT_TRUE(length(ahIoMapping) == 1);
MU_ASSERT_TRUE(~isempty(mxx_xmltree('get_nodes', ahIoMapping, ['./Path[@refId="id0" and', ...
    ' @path="top_A/Subsystem/top_A/sub_B5/Gain(1)"]'])));
