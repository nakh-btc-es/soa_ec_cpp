function ut_bug_8897
% UPDATED LEGACY UT
% Old name: ut_mt01_bug_8897
% checking fix for BTS/8897 and BTS/9343
...
%%
if isunix()
    MU_MESSAGE('TEST SKIPPED: Skipping UT for Linux because the upgrade of the test model reproducibly throws errors.');
    return;
end
