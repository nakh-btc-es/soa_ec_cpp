function ut_ep_aob_model_01
% Checking rejection mechanism for subsystems with AoB signals in their IO interface.
%

%%
if verLessThan('tl', '5.2')
    MU_MESSAGE('TEST SKIPPED: Testdata is using AoB signals supported by TL5.2 and higher.');
    return;
end
