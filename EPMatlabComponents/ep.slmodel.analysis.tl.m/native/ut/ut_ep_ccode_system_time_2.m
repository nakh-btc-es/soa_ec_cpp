...
sPwd      = pwd();
sTestRoot = fullfile(sPwd, 'ut_ep_ccode_system_time_2');
sDataDir  = fullfile(ut_local_testdata_dir_get(), 'system_time_ref');
...
fclose(hFile);
% check if exactly one btc_system_time.c file is in the files list of the CodeModel.xml
