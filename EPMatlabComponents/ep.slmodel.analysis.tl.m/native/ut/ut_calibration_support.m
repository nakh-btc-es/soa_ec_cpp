function ut_calibration_support
% UPDATED LEGACY UT
% Old name: ut_simenv_ft01_ma_b6302
%
% Suite: ModelAna; BTS/6302
% Test: SC1008: CalibrationSupport : 'Cal - invariant:
% vectorized Simulink blocks' ModelAnalysis does not contain CalSat2 inputs

%% cleanup
sltu_cleanup();

%% arrange
sUTModel = 'calibration_support';
sUTSuite = 'UT_TL';
