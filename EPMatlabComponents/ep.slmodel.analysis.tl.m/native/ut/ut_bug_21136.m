function ut_bug_21136
% UPDATED LEGACY UT
% Old name: ut_mt01_bug_21136
%
%   REMARK
%    * testing fix for following problem:
%       - TopLevel has RESTART _and_ INIT function
%       -> only the RESTART function is acknowledged by the ET, the INIT function
%          is ignored
%
% checking fix for BTS/21136
