function ut_modelref_02
% Checking handling of model references.
%

%%
if (~verLessThan('matlab', '9.5') && verLessThan('matlab', '9.6'))
    MU_MESSAGE('TEST SKIPPED: Initializing test model with ML2018b produces errors not seen for any other ML version.');
    return;
end
