function ut_integrator_model
%
%   REMARK
%     Check correct identification of limitation BTS/23302. 
%
%     CAL variables inside Discrete-Time Integrator blocks are not selected as
%     Explicit Parameters.
%
%     (see also Bug BTS/23276)
