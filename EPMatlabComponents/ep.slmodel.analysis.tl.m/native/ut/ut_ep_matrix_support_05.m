function ut_ep_matrix_support_05
...
sPwd      = pwd();
sTestRoot = fullfile(sPwd, 'ut_ep_matrix_support_05');
sDataDir  = fullfile(ut_local_testdata_dir_get(), 'matrix_sig_models', 'matrix_sig5', 'tl40');
...
i_check_interface_object(hTlRoot, 'outport', 'Out2', [], 3, 1, 'double', 'fixedPoint', 1);
