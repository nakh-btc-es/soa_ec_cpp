function ut_bug_27530
% UPDATED LEGACY UT
% Old name: ut_mt01_bug_27530
%
%   REMARK
%    * BTS/27530
%      Error situation: All functions except for the Dummy TopLevel are thrown
%      out of the ModelAnalysis because a missing corresponance to the SL model.
%      --> Instead of throwing an error MA is concluded successfully.
%      Fix: Throw exception stating the problem.
%
% checking fix for BTS/27530
