function it_slmil_SameParamNamesInSLDDAndInWS()
% Tests the ep_sim_harness_create method
if verLessThan('matlab' , '9.6')
    MU_MESSAGE('Test skipped! Linking a DD and the WS to a model is possible starting with ML2019a.');
    return
end
[xOnCleanUpCloseModel, stTestData] = sltu_prepare_simenv('SameParamNamesInSLDDAndInWS', 'SL', 'SameParamNamesInSLDDAndInWS', ...
    'SameParamNamesInSLDDAndInWS'); %#ok
