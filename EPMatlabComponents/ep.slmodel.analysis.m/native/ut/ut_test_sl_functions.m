function ut_test_sl_functions
% Checking SL analysis functionality.
%

%%
if verLessThan('matlab', '9.0')
    MU_MESSAGE('SKIPPING TEST: Test model only available for ML2016a and higher.');
    return;
end

%% prepare test
sModelKey  = 'SimulinkFunctions';
sSuiteName = 'SL';
