function ut_model_workspace_params_03
%   Check handling of model workspace parameters.
%


%% prepare test
sModelKey  = 'model_workspace_params_03';
sSuiteName = 'UT_SL';
...
sExpectedSlArch = fullfile(sTestDataDir, sFolderName, 'slArch.xml');
