function stOpt = ut_sl_options_prepare(stOpt, sTargetDir)
...
%%
function sPath = i_ep_dspaceroot()
...
%%
function i_fakeCodegenXML(stEnv, sTlSubsystem, sUserFileList, sCodegenXml, bAdaptiveAutosar)
...
atgcv_m02_export_codegen_xml(stEnv, stCombined, sUserFileList, sCodegenXml, bAdaptiveAutosar);
end
