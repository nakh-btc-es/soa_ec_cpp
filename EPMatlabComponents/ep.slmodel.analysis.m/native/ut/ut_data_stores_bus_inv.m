function ut_data_stores_bus_inv
% Check support for Data Stores with buses as origin/destination. This
% model has a higher complexity than the first one.
%

%%
if verLessThan('matlab', '9.6')
    MU_MESSAGE('SKIPPING TEST: Currently test model only available for ML2019a and higher.');
    return;
end
