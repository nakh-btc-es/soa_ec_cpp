function ut_data_stores_04
% Check support for Data Stores.
%

%% prepare test
sModelKey  = 'data_stores_04';
sSuiteName = 'UT_SL';
...
[xOnCleanupDoCleanupEnv, xEnv, sResultDir, stTestData] = sltu_prepare_ats_env(sModelKey, sSuiteName, sTestRoot, 'UTF-8');
