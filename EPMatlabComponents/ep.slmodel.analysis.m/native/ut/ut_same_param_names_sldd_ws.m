function ut_same_param_names_sldd_ws
% Check handling of parameters that are defined in WS and in SLDD.
%

%%
if verLessThan('matlab', '9.6')
    MU_MESSAGE('SKIPPING TEST: Mixture of base workspace and SLDD only for ML2019a and higher.');
    return;
end

%% prepare test
sModelKey  = 'SameParamNamesInSLDDAndInWS';
sSuiteName = 'SL';
